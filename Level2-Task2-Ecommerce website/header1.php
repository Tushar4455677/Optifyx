  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index2.php" style="color:white;">Home</a>
</li>
      </ul>
      ...
      <div>
        ...
        ?>
        <a href="my_cart1.php" class="btn btn-outline-info" style="background-color:red;">My cart(<?php echo $count; ?>)</a>
      </div>
    </div>
  </div>
</nav>
